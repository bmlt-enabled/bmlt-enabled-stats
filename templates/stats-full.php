...
<div class="blst-stats-container blst-theme-<?php echo esc_attr( $theme ); ?>">
    ...
    <section class="blst-section blst-wordpress-section">
        ...
        <div class="blst-plugin-grid">
            <?php foreach ( $wp_stats['plugins'] as $plugin ) : ?>
            <div class="blst-plugin-card">
                ...
                <div class="blst-plugin-stats">
                    <div class="blst-plugin-stat">
                        <span class="blst-stat-value"><?php echo esc_html( Shortcodes::format_number( $plugin['active_installs'] ) ); ?>+</span>
                        <span class="blst-stat-label"><?php esc_html_e( 'Active Installs', 'bmlt-enabled-stats' ); ?></span>
                    </div>
                    <div class="blst-plugin-stat">
                        <span class="blst-stat-value"><?php echo esc_html( Shortcodes::format_number( $plugin['downloaded'] ) ); ?></span>
                        <span class="blst-stat-label"><?php esc_html_e( 'Downloads', 'bmlt-enabled-stats' ); ?></span>
                    </div>
                </div>
                <div class="blst-plugin-bar">
                    <div class="blst-bar-fill" style="width: <?php echo esc_attr( min( 100, ( $plugin['active_installs'] / max( 1, $wp_stats['total_active_installs'] ) ) * 200 ) ); ?>%"></div>
                </div>
